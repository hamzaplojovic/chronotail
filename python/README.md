...
Python bindings for Chronotail C ABI v2. The currently validated macOS ARM64
wheel bundles `libchronotail.dylib` and requires no third-party runtime package.
